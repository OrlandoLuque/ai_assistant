...
pub use self_correction::{
    ...
    sanitize_for_feedback as sanitize_correction_feedback, AgentHandoffTask,
    AttemptRecord as CorrectionAttemptRecord, CitationIssue, CitationRegenerateFn,
    CitationValidateFn, CitationValidationResult, ClaimIssue, ClaimVerificationTask,
    CodeCompileTask, CodeCompileTaskCell, CodeRegenerateFn, CodeTestTask, CompileCheckResult,
    CompileFn, CompileIssue, CorrectableTask, CorrectionLedger, HandoffIssue, HandoffRegenerateFn,
    HandoffValidateFn, HandoffValidationResult, Issue as CorrectionIssue,
    LedgerEntry as CorrectionLedgerEntry, LedgerError as CorrectionLedgerError,
    ResearchCitationTask, SafetyCheckResult, SafetyGuardrailTask, SafetyIssue, SafetyIssueSpec,
    SafetyRegenerateFn, SafetyValidateFn, SelfCorrectionConfig, SelfCorrectionEngine,
...
pub use autonomous_loop::{
    AgentControl, AgentResult as AutonomousAgentResult, AgentState as AutonomousAgentState,
    AutonomousAgent, AutonomousAgentBuilder, AutonomousAgentConfig, InterAgentMessage,
...
// =============================================================================
// SETUP & MANAGEMENT (always available)
// =============================================================================
