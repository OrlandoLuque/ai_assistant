...
|-------|-------|-------------|
| Unit tests (`#[test]`) | 7,299 | `cargo test --lib --features "full,autonomous,scheduler,butler,browser,distributed-agents,containers,audio,workflows,prompt-signatures,a2a,voice-agent,media-generation,distillation,constrained-decoding,hitl,webrtc,devtools,eval-suite,chaos-testing"` |
...
**Total: 7,299 tests** (lib tests, verified with `cargo test --features "full,autonomous,scheduler,butler,browser,distributed-agents,containers,audio,workflows,prompt-signatures,a2a,voice-agent,media-generation,distillation,constrained-decoding,hitl,webrtc,devtools,eval-suite,chaos-testing" --lib`)
...
| v67 (Audio Pipeline + Voice Cloning + Agent Mode) | 7,299 | +42 | 2026-03-27 |
| v68 (LLM-Enhanced Pipeline — 17 modules) | 7,299 | +69 | 2026-03-31 |
| v69 (Enhanced Heuristics + LLM Optimization) | 7,299 | +24 | 2026-03-31 |
